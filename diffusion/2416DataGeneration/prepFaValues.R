...
# Now write the csv
write.csv(output.df, '/data/joy/BBL/studies/pnc/n2416_dataFreezeJan2017/neuroimaging/dti/n2416_DTI_JHUTractFA.csv', quote=F, row.names=F)
...
write.csv(output.df, '/data/joy/BBL/studies/pnc/n2416_dataFreezeJan2017/neuroimaging/dti/n2416_DTI_JHULabelsFA.csv', quote=F, row.names=F)
