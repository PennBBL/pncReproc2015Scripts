...
# Now write the csv
write.csv(output.df, '/data/joy/BBL/studies/pnc/n2416_dataFreezeJan2017/neuroimaging/dti/n2416_DTI_JHUTractRD.csv', quote=F, row.names=F)
...
write.csv(output.df, '/data/joy/BBL/studies/pnc/n2416_dataFreezeJan2017/neuroimaging/dti/n2416_DTI_JHULabelsRD.csv', quote=F, row.names=F)
