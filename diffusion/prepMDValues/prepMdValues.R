...
colnames(mdVals) <- c('scanid', 'bblid', as.character(namesToAdd$X))
...
# Now write the csv
write.csv(output.df, '/data/joy/BBL/studies/pnc/n1601_dataFreeze2016/neuroimaging/dti/n1601_jlfMDValues.csv', quote=F, row.names=F)
