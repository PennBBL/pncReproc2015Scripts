...
# Now write the csv
write.csv(output.df, '/data/joy/BBL/studies/pnc/n1601_dataFreeze2016/neuroimaging/dti/n1601_JHUTractAD.csv', quote=F, row.names=F)
...
write.csv(output.df, '/data/joy/BBL/studies/pnc/n1601_dataFreeze2016/neuroimaging/dti/n1601_JHULabelsAD.csv', quote=F, row.names=F)
