...
outfiledir="/data/joy/BBL/projects/pncReproc2015/n2416QAT1/t1QA/data/${appendOut1}_qa_logs"
outfile="${outfiledir}/${appendOut1}outfile${appendOut2}.csv"
infile="/data/joy/BBL/projects/pncReproc2015/n2416QAT1/t1QA/data/mprageList.txt"
