...
xcp <- read.csv('/data/joy/BBL/projects/pncReproc2015/pncReproc2015Scripts_mv_20161007/restbold/quality/REST_XCP.csv')
b0 <- read.csv('/data/joy/BBL/projects/pncReproc2015/pncReproc2015Scripts_mv_20161007/dico/n1601_b0map_nos.csv')
