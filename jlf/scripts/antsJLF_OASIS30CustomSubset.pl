...
my $usage = qq{
  ...
  ANTSPATH=/data/jet/grosspeople/Volumetric/SIEMENS/pipedream2014/antsJLF/bin/
...
my $brainDir="/data/jet/grosspeople/Volumetric/SIEMENS/pipedream2014/antsMalf/data/OASIS30/Heads";

if ($brainExtracted > 0) {
    $brainDir="/data/jet/grosspeople/Volumetric/SIEMENS/pipedream2014/antsMalf/data/OASIS30/Brains";
}

my $segDir="/data/jet/grosspeople/Volumetric/SIEMENS/pipedream2014/antsMalf/data/OASIS30/Segmentations";
...
system("${antsPath}antsJointLabelFusion.sh -d 3 -q 0 -k $keepWarps -t $target -o $outputRoot -c 1 $atlasString");
