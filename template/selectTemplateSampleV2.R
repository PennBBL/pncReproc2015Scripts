#load data
go1Name<-"/data/jag/BBL/studies/pnc/subjectData/n1601_go1_datarel_073015.csv"
...
templateSubjData$img<-NA

#find images
for( i in 1:nrow(templateSubjData) ){
	templateSubjData[i, 'img']<-Sys.glob(file.path(paste('/data/jag/BBL/studies/pnc/rawData/',templateSubjData[i,'bblid'],'/*x',templateSubjData[i,'scanid'],'/mprage/',templateSubjData[i,'bblid'],'*',templateSubjData[i,'scanid'],'*t1.nii.gz',sep='')))
	file.symlink(templateSubjData[i, 'img'],'/data/jag/BBL/projects/pncReproc2015/template/images/')
}

#write out lists
write.table(templateSubj,"/data/jag/BBL/projects/pncReproc2015/template/subjectLists/n120_templateBblids.txt",row.names=FALSE,col.names=FALSE,quote=FALSE)
write.csv(templateSubjData,"/data/jag/BBL/projects/pncReproc2015/template/subjectLists/n120_templateSubjData.csv",row.names=FALSE,quote=FALSE)
