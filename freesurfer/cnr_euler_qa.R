...
###    (from /data/joy/BBL/projects/pncReproc2015/pncReproc2015Scripts/freesurfer/QA.sh)
...
#write table out
write.csv(cor_cnr_euler_table,"/data/joy/BBL/studies/pnc/subjectData/freesurfer/go1_go2_go3_fs53_cnr_euler_correlation_table.csv")

####EULER AND AUTO QA MEASURES

#read in auto qa csv
auto_qa<- read.csv("/data/joy/BBL/projects/pncReproc2015/freesurfer/stats5_3/all.flags.n2496.csv")
...
#write out table
write.csv(cor_autoqa_table,"/data/joy/BBL/studies/pnc/subjectData/freesurfer/go1_go2_go3_fs53_cnr_euler_autoqa_correlation_table.csv")
...
pdf("/data/joy/BBL/studies/pnc/subjectData/freesurfer/go1_go2_go3_fs53_cnr_euler_distribution_plots.pdf")
...
write.csv(flags,"/data/joy/BBL/projects/pncReproc2015/freesurfer/stats5_3/cnr_euler_flags_n2496.csv")
