...
export output_dir=/data/joy/BBL/projects/pncReproc2015/freesurfer/stats5_3/n2416
...
t1_qa=/data/joy/BBL/studies/pnc/n1601_dataFreeze2016/n1601_summaryData/t1/n1601_t1QaData.csv
...
/data/joy/BBL/projects/pncReproc2015/pncReproc2015Scripts_mv_20161007/freesurfer/aparc.stats.meanthickness.totalarea.sh $slist $output_dir $SUBJECTS_DIR 
...
/share/apps/R/R-3.1.1/bin/R --slave --file=/data/joy/BBL/projects/pncReproc2015/pncReproc2015Scripts_mv_20161007/freesurfer/flag_outliers_go1_apply.R --args $output_dir $go1_list $sdthresh $t1_qa

##### 6) Flag  (gray/csf flag, gray/white flag, euler number flag, number outliers rois thickness flag, total outliers)##### 
/share/apps/R/R-3.1.1/bin/R --slave --file=/data/joy/BBL/projects/pncReproc2015/pncReproc2015Scripts_mv_20161007/freesurfer/cnr_euler_qa_go1_apply.R --args $output_dir $go1_list $t1_qa
