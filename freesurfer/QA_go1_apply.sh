...
t1_qa=/data/joy/BBL/studies/pnc/n1601_dataFreeze/neuroimaging/t1struct/n1601_t1QaData.csv
...
/data/joy/BBL/projects/pncReproc2015/pncReproc2015Scripts_mv_20161007/freesurfer/aparc.stats.meanthickness.totalarea.sh $slist $output_dir $SUBJECTS_DIR $subjnum
...
/data/joy/BBL/projects/pncReproc2015/pncReproc2015Scripts/freesurfer/cnr_euler_number_calculation.sh $slist $SUBJECTS_DIR $output_dir $subjnum

##### 5) Flag subjects based on whether they are an outlier (>2 SD) on several measures##### 
/share/apps/R/R-3.1.1/bin/R --slave --file=/data/joy/BBL/projects/pncReproc2015/pncReproc2015Scripts_mv_20161007/freesurfer/flag_outliers_go1_apply.R --args $output_dir $go1_list $sdthresh $t1_qa $subjnum

##### 6) Flag  (gray/csf flag, gray/white flag, euler number flag, number outliers rois thickness flag, total outliers)##### 
/share/apps/R/R-3.1.1/bin/R --slave --file=--file=/data/joy/BBL/projects/pncReproc2015/pncReproc2015Scripts/freesurfer/cnr_euler_qa_go1_apply.R --args $output_dir $go1_list $t1_qa $subjnum
