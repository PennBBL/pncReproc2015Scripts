...
#Read in Datasets
dataMeanAct <- read.csv("/data/joy/BBL/projects/pncReproc2015/idemo/QA/data/n1601_idemo_MeanActivation.csv", header=F)
dataMaskCov <- read.csv("/data/joy/BBL/projects/pncReproc2015/idemo/QA/data/n1601_maskCoverage_QA.csv")
dataQA <- read.csv("/data/joy/BBL/projects/pncReproc2015/idemo/QA/data/n1601_idemo_QAMetrics.csv")
...
maxDat <- read.csv("/data/joy/BBL/projects/pncReproc2015/idemo/QA/data/n1601_idemo_MaxRMS.csv")
