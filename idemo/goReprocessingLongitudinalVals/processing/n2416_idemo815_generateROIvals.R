...
data <- read.csv("/data/joy/BBL/projects/pncReproc2015/idemo/goReprocessingLongitudinalVals/QA/n815_idemo_FinalQA.csv")
data <- data[which(data$Exclude.acquired == 0), ]

glasser <- as.data.frame(matrix(NA, ncol = 6000, nrow=805))
...
write.csv(glasser, "/home/agarza/pncReproc2015Scripts/idemo/goReprocessingLongitudinalVals/dataRelease/n815_idemo_glasser_roivals.csv", row.names=F)
...
jlf <- as.data.frame(matrix(NA, ncol = 3500, nrow=805))
...
write.csv(jlf, "/home/agarza/pncReproc2015Scripts/idemo/goReprocessingLongitudinalVals/dataRelease/n815_idemo_jlf_roivals.csv", row.names=F)
...
jlf.intersect <- as.data.frame(matrix(NA, ncol = 3500, nrow=805))
namesjlf <- read.csv("/data/joy/BBL/studies/pnc/n1601_dataFreeze2016/neuroimaging/pncTemplate/jlf/jlf_lookup.csv", header = F)
namesjlf$V1 <- as.character(namesjlf$V1)
namesjlf$V2 <- as.character(namesjlf$V2)
...
write.csv(jlf.intersect, "/home/agarza/pncReproc2015Scripts/idemo/goReprocessingLongitudinalVals/dataRelease/n815_idemo_jlf_intersect_roivals.csv", row.names=F)
