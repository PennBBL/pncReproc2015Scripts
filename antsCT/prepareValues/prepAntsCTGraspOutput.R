...
system("$XCPEDIR/utils/combineOutput -p /data/joy/BBL/studies/pnc/processedData/structural/antsCorticalThickness/ -f graspPNC227_antsCT_val.1D  -o antsCT_grasp227_vals.1D")
system("mv /data/joy/BBL/studies/pnc/processedData/structural/antsCorticalThickness/antsCT_grasp227_vals.1D /data/joy/BBL/projects/pncReproc2015/antsCT/grasp227AntsCTVals.1D") 
ctValues <- read.table("/data/joy/BBL/projects/pncReproc2015/antsCT/grasp227AntsCTVals.1D", header=T)
...
columnNames <- paste('mprage_grasp227_ct_roi', seq(1,226), sep='')
